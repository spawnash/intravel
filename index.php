				...
				<div class="tm-home-box-1">
					<ul class="nav nav-tabs tm-white-bg" role="tablist" id="hotelCarTabs">
					    <li role="presentation" class="active">
					    	<a href="#hotel" aria-controls="hotel" role="tab" data-toggle="tab">住宿</a>
					    </li>
					</ul>
					<!-- Tab panes -->
		...
		<div class="section-margin-top">
			<div class="row">				
				<div class="tm-section-header">
					...
					<div class="col-lg-6 col-md-6 col-sm-6"><h2 class="tm-section-title">熱銷行程</h2></div>
					<div class="col-lg-3 col-md-3 col-sm-3"><hr></div>	
				</div>
			</div>
			<div class="row">
                <?php if(!empty($datas)):?>
                <?php foreach($datas as $tour):?>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-home-box-2">						
						<img src="<?php echo $tour['image_path']; ?>" alt="image" class="img-responsive">
						<h3><?php echo $tour['intro']; ?></h3>
						<p class="tm-date"><?php echo $tour['upload_date']; ?></p>
						<div class="tm-home-box-2-container">
							<a href="#" class="tm-home-box-2-link"><i class="fa fa-heart tm-home-box-2-icon border-right"></i></a>
							<a href="tours.php?i=<?php echo $tour['id']?>" class="tm-home-box-2-link"><span class="tm-home-box-2-description">Travel</span></a>
			...
			<!--<div class="row">
				<div class="col-lg-12">
					<p class="home-description"> tour and travel websites.</p>
				</div>
			</div>-->
		</div>
	</section>		
		...
		<div class="container">
			<div class="row">
				<div class="tm-section-header section-margin-top">
					...
					<div class="col-lg-4 col-md-6 col-sm-6"><h2 class="tm-section-title">精選行程</h2></div>
					<div class="col-lg-4 col-md-3 col-sm-3"><hr></div>	
				</div>
				<div class="col-lg-6">
